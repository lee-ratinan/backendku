        ...
        <div class="sidebar-content js-simplebar">
            ...
            <ul class="sidebar-nav">
                ...
                <?php if (isset($session->permitted_features['finance'])): ?>
                    ...
                    <li class="sidebar-item <?= ('investment' == $slug ? 'active' : '' ) ?>"><a class="sidebar-link disabled" disabled href="<?= base_url($session->locale . '/office/investment') ?>"><i class="fa-solid fa-line-chart fa-fw me-3"></i><span>Investment</span></a></li>
