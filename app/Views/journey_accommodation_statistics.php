...
<?php $session = session(); ?>
    <div class="pagetitle">
        <div class="float-end">
            ...
            <a class="btn btn-outline-primary btn-sm me-3 disabled" href="<?= base_url($session->locale . '/office/journey/accommodation/statistics') ?>" disabled><i class="fa-solid fa-bed"></i> Accommodation</a>
