...
<?php $session = session(); ?>
    <div class="pagetitle">
        <div class="float-end">
            <a class="btn btn-outline-primary btn-sm me-3 disabled" href="<?= base_url($session->locale . '/office/journey/trip/statistics') ?>" disabled><i class="fa-solid fa-passport"></i> Trip</a>
