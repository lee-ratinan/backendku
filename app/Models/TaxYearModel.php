    ...
    public function getDataTables(int $start, int $length, string $order_column, string $order_direction, string $country_code, string $year): array
    {
        ...
        foreach ($raw_result as $row) {
            ...
            $result[]     = [
                ...
                $row['taxpayer_name'] . '<br><small>' . $row['taxpayer_id_value'] . ': ' . $row['taxpayer_id_value'] . '<br>Filing status: ' . $row['filing_status'] . '<br>Citizenship status: ' . $row['citizenship_status'] . '<br>' . $row['taxpayer_address'] . '</small>',
